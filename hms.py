...
import stdiomask
conn=sql.connect(host='localhost',user='root',passwd='/type your password here/')
if conn.is_connected():
    print('SUCCESSFULLY CONNECTED')
    c1=conn.cursor()
    c1.execute('create database if not exists hms')
    c1.execute('use hms')
    CH='yes'
    while CH.lower()=="yes":
        print()
        ...
        print("================================================================================")
        print()
        print("\t\t*_*_*_WELCOME TO HMS_*_*_*")
            ...
            while Ch.lower()=='yes':
                ...
                while ch.lower()=="yes":
                    if u1=='ADMIN'and pwd1=='iamadmin':
                        ...
                        if choice==1:
                            c1.execute('create table if not exists patient_details(p_id varchar(10) primary key not null,p_name char(20),p_age int(3),p_problems char(20),p_phoneno int(15))')
                            c1.execute('create table if not exists staff_details(st_id varchar(10) primary key not null,st_name char(20),st_age int(3),st_department char(20),st_phoneno int(15))')
                            c1.execute('create table if not exists doctor_details(d_id varchar(10) primary key not null,d_name char(20),d_age int(3),d_department char(20),d_phoneno int(15))')
                            c1.execute('create table if not exists nurse_details(n_id varchar(10) primary key not null,n_name char(20),n_age int(3),n_department char(20),n_phoneno int(15))')
                            ch1="yes"
                            print()
                            print("================================================================================")
                            print()
                            ...
                            while ch1.lower()=="yes":
                                ...
                                if choice1==1:
                                    ...
                                    sql_insert="insert into patient_details(p_id,p_name,p_age,p_problems,p_phoneno) values(%s,%s,%s,%s,%s)"
                                    ...
                                    sql_insert="insert into doctor_details(d_id,d_name,d_age,d_department,d_phoneno) values(%s,%s,%s,%s,%s)"
                                    ...
                                    sql_insert="insert into nurse_details(n_id,n_name,n_age,n_department,n_phoneno) values(%s,%s,%s,%s,%s)"
                                    ...
                                    sql_insert="insert into staff_details(st_id,st_name,st_age,st_department,st_phoneno) values(%s,%s,%s,%s,%s)"
...
10.View members of specific Department")
                            ...
                            while ch2.lower()=='yes':
                                ...
                                if choice2==1:
                                    ...
                                    c1.execute('select d.d_department,n.n_department from doctor_details d,nurse_details n')
                                    y=c1.fetchall()
                                    dpt=[]
                                    if y==[]:
                                        print('\n! ! No records found ! !\n')
                                    ...
                                    c1.execute('select d_name from doctor_details where d_department=%s',(dept.upper(),))
                                    y=c1.fetchall()
                                    c1.execute('select n_name from nurse_details where n_department=%s',(dept.upper(),))
                                    z=c1.fetchall()
                                    if y==[]:
                                            ...
                                            while chA.lower()=='yes':
                                                ...
                                                if choiceA==1:
                                                    ...
                                                    if t==[]:
                                                        ...
                                                        c1.execute('UPDATE patient_details SET p_name=%s WHERE p_id=%s',(p_name,p_id))
                                                    ...
                                                    if t==[]:
                                                        ...
                                                        c1.execute('UPDATE patient_details SET p_age=%s WHERE p_id=%s',(p_age,p_id))
                                                        print('====================SUCCESSFULLY UPDATED====================')
                                                        c1.execute('select*from patient_details where p_id=%s',(p_id,))
                                                        v=c1.fetchall()
                                                        print("PATIENT ID\t\tPATIENT NAME\t\tAGE\t\t\tPROBLEM\t\t\tCONTACT NO.")
                                                    ...
                                                    c1.execute('SELECT p_problems FROM patient_details WHERE p_id=%s',(p_id,))
                                                    t=c1.fetchall()
                                                    if t==[]:
                                                        print('\n! ! No  such record found ! !\n')
                                                    else:
                                                        ...
                                                        c1.execute('UPDATE patient_details SET p_problems=%s WHERE p_id=%s',(p_problems,p_id))
                                                        print('====================SUCCESSFULLY UPDATED====================')
                                                        c1.execute('select*from patient_details where p_id=%s',(p_id,))
                                                        v=c1.fetchall()
                                                        print("PATIENT ID\t\tPATIENT NAME\t\tAGE\t\t\tPROBLEM\t\t\tCONTACT NO.")
                                                    ...
                                                    c1.execute('SELECT p_phoneno FROM patient_details WHERE p_id=%s',(p_id,))
                                                    t=c1.fetchall()
                                                    if t==[]:
                                                        print('\n! ! No  such record found ! !\n')
                                                    else:
                                                        ...
                                                        c1.execute('UPDATE patient_details SET p_phoneno=%s WHERE p_id=%s',(p_phoneno,p_id))
                                                        print('====================SUCCESSFULLY UPDATED====================')
                                                        c1.execute('select*from patient_details where p_id=%s',(p_id,))
                                                        v=c1.fetchall()
                                                        print("PATIENT ID\t\tPATIENT NAME\t\tAGE\t\t\tPROBLEM\t\t\tCONTACT NO.")
                                            ...
                                            while chA.lower()=='yes':
                                                ...
                                                if choiceA==1:
                                                    ...
                                                    if t==[]:
                                                        ...
                                                        c1.execute('UPDATE doctor_details SET d_name=%s WHERE d_id=%s',(d_name,d_id))
                                                        print('====================SUCCESSFULLY UPDATED====================')
                                                    ...
                                                    if t==[]:
                                                        ...
                                                        c1.execute('UPDATE doctor_details SET d_age=%s WHERE d_id=%s',(d_age,d_id))
                                                        print('====================SUCCESSFULLY UPDATED====================')
                                                        c1.execute('select*from doctor_details where d_id=%s',(d_id,))
                                                        v=c1.fetchall()
                                                        print("DOCTOR ID\t\tDOCTOR NAME\t\t\tAGE\t\t\tDEPARTMENT\t\tCONTACT NO.")
                                                    ...
                                                    c1.execute('SELECT d_department FROM doctor_details WHERE d_id=%s',(d_id,))
                                                    t=c1.fetchall()
                                                    if t==[]:
                                                        print('\n! ! No  such record found ! !\n')
                                                        ...
                                                        c1.execute('UPDATE doctor_details SET d_department=%s WHERE d_id=%s',(d_department,d_id))
                                                        print('====================SUCCESSFULLY UPDATED====================')
                                                        c1.execute('select*from doctor_details where d_id=%s',(d_id,))
                                                        v=c1.fetchall()
                                                        print("DOCTOR ID\t\tDOCTOR NAME\t\t\tAGE\t\t\tDEPARTMENT\t\tCONTACT NO.")
                                                    ...
                                                    c1.execute('SELECT d_phoneno FROM doctor_details WHERE d_id=%s',(d_id,))
                                                    t=c1.fetchall()
                                                    if t==[]:
                                                        print('\n! ! No  such record found ! !\n')
                                                    else:
                                                        ...
                                                        c1.execute('UPDATE doctor_details SET d_phoneno=%s WHERE d_id=%s',(d_phoneno,d_id))
                                                        print('====================SUCCESSFULLY UPDATED====================')
                                                        c1.execute('select*from doctor_details where d_id=%s',(d_id,))
                                                        v=c1.fetchall()
                                                        print("DOCTOR ID\t\tDOCTOR NAME\t\t\tAGE\t\t\tDEPARTMENT\t\tCONTACT NO.")
                                            ...
                                            while chA.lower()=='yes':
                                                ...
                                                if choiceA==1:
                                                    ...
                                                    if t==[]:
                                                        ...
                                                        c1.execute('UPDATE nurse_details SET n_name=%s WHERE n_id=%s',(n_name,n_id))
                                                        print('====================SUCCESSFULLY UPDATED====================')
                                                    ...
                                                    if t==[]:
                                                        ...
                                                        c1.execute('UPDATE nurse_details SET n_age=%s WHERE n_id=%s',(n_age,n_id))
                                                        print('====================SUCCESSFULLY UPDATED====================')
                                                        c1.execute('select*from nurse_details where n_id=%s',(n_id,))
                                                        v=c1.fetchall()
                                                        print("NURSE ID\t\tNURSE NAME\t\t\tAGE\t\t\tDEPARTMENT\t\tCONTACT NO.")
                                                    ...
                                                    c1.execute('SELECT n_department FROM nurse_details WHERE n_id=%s',(n_id,))
                                                    t=c1.fetchall()
                                                    if t==[]:
                                                        print('\n! ! No  such record found ! !\n')
                                                    else:
                                                        ...
                                                        c1.execute('UPDATE nurse_details SET n_department=%s WHERE n_id=%s',(n_department,n_id))
                                                        print('====================SUCCESSFULLY UPDATED====================')
                                                        c1.execute('select*from nurse_details where n_id=%s',(n_id,))
                                                        v=c1.fetchall()
                                                        print("NURSE ID\t\tNURSE NAME\t\t\tAGE\t\t\tDEPARTMENT\t\tCONTACT NO.")
                                                    ...
                                                    if t==[]:
                                                        ...
                                                        c1.execute('UPDATE nurse_details SET n_phoneno=%s WHERE n_id=%s',(n_phoneno,n_id))
                                                        print('====================SUCCESSFULLY UPDATED====================')
                                                        c1.execute('select*from nurse_details where n_id=%s',(n_id,))
                                                        v=c1.fetchall()
                                                        print("NURSE ID\t\tNURSE NAME\t\t\tAGE\t\t\tDEPARTMENT\t\tCONTACT NO.")
                                            ...
                                            while chA.lower()=='yes':
                                                ...
                                                if choiceA==1:
                                                    ...
                                                    if t==[]:
                                                        ...
                                                        c1.execute('UPDATE staff_details SET st_name=%s WHERE st_id=%s',(st_name,st_id))
                                                        print('====================SUCCESSFULLY UPDATED====================')
                                                    ...
                                                    if t==[]:
                                                        ...
                                                        c1.execute('UPDATE staff_details SET st_age=%s WHERE st_id=%s',(st_age,st_id))
                                                        print('====================SUCCESSFULLY UPDATED====================')
                                                        c1.execute('select*from staff_details where st_id=%s',(st_id,))
                                                        v=c1.fetchall()
                                                        print("STAFF ID\t\tSTAFF NAME\t\t\tAGE\t\t\tDEPARTMENT\t\tCONTACT NO.")
                                                    ...
                                                    c1.execute('SELECT st_department FROM staff_details WHERE st_id=%s',(st_id,))
                                                    t=c1.fetchall()
                                                    if t==[]:
                                                        print('\n! ! No  such record found ! !\n')
                                                    else:
                                                        ...
                                                        c1.execute('UPDATE staff_details SET st_department=%s WHERE st_id=%s',(st_department,st_id))
                                                        print('====================SUCCESSFULLY UPDATED====================')
                                                        c1.execute('select*from staff_details where st_id=%s',(st_id,))
                                                        v=c1.fetchall()
                                                        print("STAFF ID\t\tSTAFF NAME\t\t\tAGE\t\t\tDEPARTMENT\t\tCONTACT NO.")
                                                    ...
                                                    c1.execute('SELECT st_phoneno FROM staff_details WHERE st_id=%s',(st_id,))
                                                    t=c1.fetchall()
                                                    if t==[]:
                                                        print('\n! ! No  such record found ! !\n')
                                                    else:
                                                        ...
                                                        c1.execute('UPDATE staff_details SET st_phoneno=%s WHERE st_id=%s',(st_phoneno,st_id))
                                                        print('====================SUCCESSFULLY UPDATED====================')
                                                        c1.execute('select*from staff_details where st_id=%s',(st_id,))
                                                        v=c1.fetchall()
                                                        print("STAFF ID\t\tSTAFF NAME\t\t\tAGE\t\t\tDEPARTMENT\t\tCONTACT NO.")
    ...
    print()
    print("! ! (^_^) Thank You for visitng HMS(^_^) ! !")
    print("! ! \t\t~ Your Health is in GOOD hands ~\t    ! !")
    print()
    conn.close()
else:
